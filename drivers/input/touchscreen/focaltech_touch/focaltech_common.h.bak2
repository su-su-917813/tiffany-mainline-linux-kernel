...
/* Gesture functions */
#if FTS_GESTURE_EN
static inline int fts_gesture_init(struct input_dev *input_dev, struct i2c_client *client) { return 0; }
int fts_gesture_exit(struct i2c_client *client);
static inline void fts_gesture_recovery(struct i2c_client *client) {}
static inline int fts_gesture_readdata(struct i2c_client *client) { return 0; }
...
/* Apk and functions */
#if FTS_APK_NODE_EN
static inline int fts_create_apk_debug_channel(struct i2c_client *client) { return 0; }
static inline void fts_release_apk_debug_channel(void) {}
#endif

/* ADB functions */
#if FTS_SYSFS_NODE_EN
static inline int fts_create_sysfs(struct i2c_client *client) { return 0; }
static inline int fts_remove_sysfs(struct i2c_client *client) { return 0; }
#endif
...
static inline int fts_ex_mode_init(struct i2c_client *client) { return 0; }
static inline int fts_ex_mode_exit(struct i2c_client *client) { return 0; }
static inline int fts_ex_mode_recovery(struct i2c_client *client) { return 0; }
